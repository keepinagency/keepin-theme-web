...
<div class="container-fluid p-0 m-0 h-100">
    ...
    <div class="header p-0 m-0 col-12 row">
        <nav class="navbar navbar-light col-12 p-0 m-0 row d-flex flex-row">
            
                <div class="col-10 p-3 m-0 ">
            ...
            <!--Area menu   area-menu   -->
            <!--div class="col-12 col-lg-12 d-lg-block col-xs-12 p-0 m-0 container navbar-expand-lg navbar-light"-->         
                <?php
                    wp_nav_menu( array(
                        'container'       => 'div',
                        'container_class' => 'collapse navbar-collapse area-menu col-12 col-lg-12 d-lg-block p-0 m-0 h-100 navbar-expand-lg navbar-light',
