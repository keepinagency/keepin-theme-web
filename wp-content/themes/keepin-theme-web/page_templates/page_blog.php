                ...
                <div class="row d-flex flex-lg-row col-12 p-0 m-0 
                    ...
                    <div class="row contblog_post col-12 m-0 p-0">
                        <div class="col-10 col-lg-8 flex-lg-row m-0 p-0 cont_tit_blog">
                            <a class="text-white p-0 m-0 text-decoration-none" href="<?php the_permalink(); ?>">
                                <div class="p-0 m-0 titleblog_post pl-lg-2">
                                    <?php the_title();?>
                                </div>
                                <div class="p-0 m-0 postblog_post text-lg-justify pl-lg-2">
                                    <?php the_excerpt();?>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center col-12 pt-2 pb-4 m-0 d-lg-none">
                        <?php the_post_thumbnail('medium', ['class' => 'img-portafolio', 'title' => 'Portafolio imagen']); ?>
                    </div>
